 ...
 */
@Data
public class ServiceFileWrapper extends JavaFileWrapper<JavaFileDefinition> {


    public ServiceFileWrapper(JavaFileDefinition definition, JavaFileWrapper entityWrapper,
                              JavaFileWrapper pageWrapper, JavaFileWrapper<JavaFileDefinition> pageQueryWrapper) {
        super(definition);
